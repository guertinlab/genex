...
wget https://raw.githubusercontent.com/guertinlab/genex/refs/heads/main/ATAC_analysis/chrM.fa
...
to do: Update with a description of DESeq2.
...
plot.barchart <- function(df.barchart, filename = "barchart_jinhong.pdf") {
  ...
  polycol$col <- c("grey20", "grey90", "#ce228e", "grey80", "#ce228e", "grey80")
...
library(knitr)
knitr::include_graphics("ATAC_PCA_plot_30min_ZNF143_degradation25.png") 
```


## Generate the MA plot figure.
...
library(knitr)
knitr::include_graphics("MA_plot_ATAC_ZNF143_30min_accessiblity_MA25.png") 
```
...
y= as.data.frame(matrix(c(14, 4, 61, 722, 763, 38, rep('Increased ATAC', 2), rep('Decreased ATAC', 2), rep('Matched', 2), 0.8333333, 0.1666667,  0.0787519,  0.9212481,  0.9337261, 0.0662739, rep(c('b','a'), 3)), ncol=4, byrow=FALSE))
...
```{r  out.width = "500px", echo=F, fig.align = "center", fig.cap="MA plot"}
library(knitr)
knitr::include_graphics("barchart_ATAC_overlap_ZNF14325.png") 
```
...
#library(knitr)
knitr::include_graphics("logo1_25.png") 
```
