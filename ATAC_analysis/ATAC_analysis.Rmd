...
library(knitr)
knitr::include_graphics("ATAC_PCA_plot_30min_ZNF143_degradation26.png") 
```
...
library(knitr)
knitr::include_graphics("MA_plot_ATAC_ZNF143_30min_accessiblity_MA26.png") 
```
...
```{r  out.width = "500px", echo=F, fig.align = "center", fig.cap="MA plot"}
library(knitr)
knitr::include_graphics("barchart_ATAC_overlap_ZNF14326.png") 
```
...
#library(knitr)
knitr::include_graphics("logo1_26.png") 
```
