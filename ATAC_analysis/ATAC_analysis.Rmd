...
y= as.data.frame(matrix(c(23, 0, 66, 730, 717, 36, rep('Increased ATAC', 2), rep('Decreased ATAC', 2), rep('Matched', 2), 1.0, 0.0,  0.09041096,  0.909589,  0.9521912, 0.0478088, rep(c('b','a'), 3)), ncol=4, byrow=FALSE))
