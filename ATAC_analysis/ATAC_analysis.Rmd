...
library(knitr)
knitr::include_graphics("ATAC_PCA_plot_30min_ZNF143_degradation.png") 
```

```{r  out.width = "50%", out.height = "50%", echo=F, fig.align = "center", fig.cap="MA plot"}
library(knitr)
knitr::include_graphics("MA_plot_ATAC_ZNF143_30min_accessiblity_MA.png") 
```
...
meme -oc ZNF143.meme_output -objfun classic -evt 0.01 -searchsize 0 -minw 5 -maxw 15 -revcomp -dna -markov_order 2 -maxsize 100000000 ZNF143_degron_ATAC_down.fasta

mast ZNF143.meme_output/meme.txt -mt 0.001 -hit_list ZNF143_degron_ATAC_down.fasta > mast_hits_decreased.txt
mast ZNF143.meme_output/meme.txt -mt 0.001 -hit_list ZNF143_degron_ATAC_matched.fasta > mast_hits_unchanged.txt
