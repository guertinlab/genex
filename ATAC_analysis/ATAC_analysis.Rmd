...
The workflow is identical to RNA-seq. If we have counts for genomic regions, then you can use `DESeq2` to find differential binding, expression, or accessibility.
