...
mkdir -p ~/genex_ATAC_all
cd ~/genex_ATAC_all
wget https://raw.githubusercontent.com/guertinlab/genex/main/ATAC_analysis/Combined_ATAC_peak_counts.bed
```
...
meme -oc ZNF143.meme_output -objfun classic -evt 0.01 -searchsize 0 -minw 5 -maxw 10 -revcomp -dna -markov_order 2 -maxsize 100000000 ATAC_decrease_ZNF143_degron.fasta
